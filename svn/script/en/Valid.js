...
function CheckValueType(o){
	...
	if (o.mInput=="true"){
		if (o.value.trim()=="")
		{
			alert(o.errmsg+' can not be empty');
			o.focus();
			return false;
		}
	}
	...
	switch (o.fType)
	{
		case "num":
			if (isNaN(o.value))
			{
				alert(o.errmsg+' must be numeric');
				o.focus();
				o.select();
				return false;
			}
		...
		case "username":
			if(!Verifyname(o.value)){
				alert(o.errmsg+' must be character, number, - _');
				o.focus();
				o.select();
				return false;
			}
		...
		case "email":
			if (o.value!="") {
				...
				if(!re.exec(s)){
					alert(o.errmsg+' format is not correct');
					o.focus();
					o.select();
					return false;
				}	
		...
		case "date":
			if (o.value!="") {
				if (!isDate(o.value)){
					alert(o.errmsg+' must be date format \n 2004-12-12 or 2004/12/12');
					o.focus();
					o.select();
					return false;
				}
		...
		case "time":
			if (o.value!="") {
				if (!isTime(o.value)){
					alert(o.errmsg+' must be time format \n 18:30:60 or 8:25');
					o.focus();
					o.select();
					return false;
				}
		...
		case "datetime":
			if (o.value!="") {
				if (!isDateTime(o.value)){
					alert(o.errmsg+' must be date and time format \n 2004-12-12 or 2004-12-12 15:30 or 2004/12/12 15:30:28');
					o.focus();
					o.select();
					return false;
				}
