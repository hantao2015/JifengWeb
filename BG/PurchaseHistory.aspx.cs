    ...
    public partial class PurchaseHistory : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!base.IsPostBack)
            {
                ...
                string strWhere = "";
                if (model.Login2type == "jf")
                {
                    strWhere = " and C3_409148801781='" + model.Mobile + "' and isnull(bgzy,'')<>'Y' ";
                }
                else
                {
                    strWhere = " and C3_409148801781='" + model.Mobile + "' and isnull(bgzy,'')='Y'";
                }
                List<IntegralConsumeModel> modelList = new IntegralConsumeBLL().GetModelList(strWhere);
