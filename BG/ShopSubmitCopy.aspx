<%@ Page Title="" Language="C#" MasterPageFile="~/Web.Master" AutoEventWireup="true" CodeBehind="ShopSubmitCopy.aspx.cs" Inherits="MaoChong.Web.ShopSubmitCopy" %>
...
<script type="text/javascript">
    $(document).ready(function() {
        //更改数量
        $("#list tr[ajax='1'] :input[ajax='1']").change(function() {
            AjaxUpdate(1, 3);
        });

        function AjaxUpdate(orderID, goodNum) {
            alert(orderID);
            $.ajax({
                type: "POST",
                dataType: "json", //返回json格式的数据
                cache: false,
                url: "Ajax/ShopCart.ashx",
                data: { OrderID: 1, GoodNum: 2 },
                beforeSend: function() { }, //请求前的操作
                complete: function() { }, //Ajax请求完成时隐藏loading提示
                error: function() { alert('请求错误'); }, //请求错误时处理
                success: function(msg) {
                    //设置上箭头
                    $("#SpanIntegral").text(msg.total);
                }
            });
        };
    });
